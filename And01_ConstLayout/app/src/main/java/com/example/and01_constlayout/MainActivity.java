...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView imgv_kyg; // 전역 변수 선언 초기상태 null
    @Override
...
//        imgv_kyg = findViewById(R.id.img_kyg);; // @IdRes = R클래스에서 내용을 찾아서 넣어주세요.  ctrl + p 하면 변수에 넘겨야할 타입이 나옴 ex)int
//
//        // 인터페이스 옵저버 패턴
//        imgv_kyg.setOnClickListener(new View.OnClickListener() {
//            @Override
